...
| Enable HTTP 2.0 |Enables Http 2.0 Accepted values: Boolean|False
  Enable Host Check|Enable Host Check Accepted values:Boolean|False
...
Max Requested Per Connection | Specify max allowed requests per keep-alive connection : Integer |1000
